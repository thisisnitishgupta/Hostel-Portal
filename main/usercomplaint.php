        ...
        <div class="row-fluid">
            <div class="span2">
                <div class="well sidebar-nav">
                    <ul class="nav nav-list">
                        ...
                        <li><a href="addusercomplaint.php"><i class="icon-group icon-2x"></i> Add Complaint</a></li>
                        <br><br>
            ...
            <div class="span10">
                <div class="contentheader">
                    <i class="icon-table"></i> HOSTEL COMPLAINT
                </div>
                <ul class="breadcrumb">
                ...
                <a href="addusercomplaint.php"><button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Add Complaint</button></a><br><br>
                <table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            <td><a  title="Click to edit the Complaint Details" href="editusercomplaint.php?id=<?php echo $row['usn']; ?>"><button class="btn btn-warning btn-mini"><i class="icon-edit"></i> Edit</button> </a></td>
                            </tr>
                        <?php
                        }
                        ?>
