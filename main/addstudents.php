  ...
  <div class="container-fluid">
    <div class="row-fluid">
      <div class="span2">
        <div class="well sidebar-nav">
          <ul class="nav nav-list">
            ...
            <li class="active"><a href="students.php"><i class="icon-group icon-2x"></i> Add Student</a></li>
            <br><br>
      ...
      <div class="span10">
        ...
        <ul class="breadcrumb">
          <li><a href="viewstudents.php">Dashboard</a></li> /
        ...
        <div style="margin-top: -19px; margin-bottom: 21px;">
          ...
          <form action="savestudents.php" method="post" enctype="multipart/form-data">
            <center>
              <h4><i class="icon-edit icon-large"></i> Add New Students </h4>
            </center>
            <hr>
            <center>
              <div id="ac">
                ...
                <br>
                <span>State: </span><input type="text" style="width:265px; height:30px;" name="state" required />
                <br>
                <span>Mobile No.: </span><input type="mobile" style="width:265px; height:30px;" name="mobile" required /><br>
                <span>Image:</span><input type="file" name="file" id="file" style="width:265px; height:50px;"><br><br>
                <div>
