          ...
          <form action="saveuserleave.php" method="post" enctype="multipart/form-data">
            ...
            <center>
              <div id="ac">
                ...
                <span>Departure Date : </span><input type="date" style="width:265px; height:30px;" name="departuredate" Required /><br>
                <span>Arrival Date : </span><input type="date" style="width:265px; height:30px;" name="arrivaldate"/><br>
                <span>Place Of Visiting : </span><input type="text" style="width:265px; height:30px;" name="place" Required /><br>
