    ...
    <div class="row-fluid">
      ...
      <div class="span10">
        ...
        <div style="margin-top: -19px; margin-bottom: 21px;">
          <a href="admin.php"><button class="btn btn-default btn-large" style=" margin-top: 19px;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a>
          <form action="saveadmin.php" method="post" enctype="multipart/form-data">
            ...
            <center>
              <div id="ac">
                ...
                <span>Admin ID: </span><input type="number" style="width:265px; height:30px;" name="id" placeholder="Admin ID" Required /><br>
                ...
                <div>
                  ...
                  <button class="btn btn-success btn-block btn-large" style="width:267px;"><i class="icon icon-save icon-large"></i> Save Admin</button>
                </div>
              </div>
          </form>
          </center>
